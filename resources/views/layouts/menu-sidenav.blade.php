<ul id="sidenav-left" class="sidenav">
    ...
    <li><a class="waves-effect" href="#">Gestionar Géneros <i class="material-icons">apps</i></a></li>
    <li><a class="waves-effect" href="#">Gestionar Libros <i class="material-icons">apps</i></a></li>
